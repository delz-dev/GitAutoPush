    ...
    <div class="card p-3">
        ...
        <div class="form-group">
            ...
            <select name="environments[]" id="environments" multiple>
                <option value="local" {{ in_array('local', config('git-auto-push.environments', [])) ? 'selected' : '' }}>Local</option>
                <option value="staging" {{ in_array('staging', config('git-auto-push.environments', [])) ? 'selected' : '' }}>Staging</option>
                <option value="production" {{ in_array('production', config('git-auto-push.environments', [])) ? 'selected' : '' }}>Production</option>
            </select>
        </div>
